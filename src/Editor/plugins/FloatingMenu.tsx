...
import { $isRangeSelected } from "../utils/$isRangeSelected.ts";
import { useUserInteractions } from "../hooks/useUserInterace.tsx";
...
function FloatingMenu({ show, ...props }: FloatingMenuProps) {
  ...
  return (
    <div
      ...
      className={`absolute flex items-center justify-between bg-white border-2 border-slate-400 rounded-md p-2 gap-1 z-50 shadow-lg ${
